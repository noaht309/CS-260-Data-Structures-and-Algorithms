...
int partition(vector<Bid>& bids, int begin, int end) {
	...
	//pick the middle elemnt as the pivot point
...
void quickSort(vector<Bid>& bids, int begin, int end) {
	...
	//recursively call quicksort using midpoint value (begin to midpoint)
	quickSort(bids, begin, mid);

	//recursively call quicksort using midpoint value (midpoint +1 to end)
